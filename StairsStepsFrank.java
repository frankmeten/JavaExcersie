...
public class StairsSteps {
	...
	public static void main(String[] args) throws IOException {
		...
		String fileName = "StairsSteps" + reportDate + ".txt";
		...
		fw.write("steps:" + Arrays.toString(steps) + System.getProperty("line.separator"));
		fw.write("TotalStairs:" + TotalStairs + System.getProperty("line.separator"));
